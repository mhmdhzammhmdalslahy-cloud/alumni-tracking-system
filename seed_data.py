...
# ==================== الحصول على نموذج Skill المرتبط بـ Graduate ====================
try:
    SkillModel = Graduate._meta.get_field('skills').related_model
    print(f"✅ تم التعرف على نموذج المهارات: {SkillModel.__name__}")
except:
    from dashboard.models import Skill as SkillModel
    print("⚠️ استخدام نموذج المهارات الافتراضي من dashboard")
...
skills_list = ['Python', 'Java', 'JavaScript', 'C++', 'SQL', 'Django', 'React', 'Node.js', 'تحليل بيانات', 'إدارة مشاريع', 'التواصل', 'القيادة', 'العمل الجماعي', 'حل المشكلات', 'التخطيط', 'التسويق الرقمي', 'التصميم', 'الكتابة التقنية', 'الترجمة', 'التدقيق المالي']
...
def get_or_create_skill(name):
    skill, created = SkillModel.objects.get_or_create(name=name)
    return skill

# ==================== بدء التعبئة ====================
print("🌍 بدء تعبئة قاعدة البيانات ببيانات يمنية وصور...")

# 1. التخصصات والمهارات
print("📚 إنشاء التخصصات والمهارات...")
